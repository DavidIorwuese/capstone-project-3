...
const Page = ({
  ...
  if (!hospital) {
    return (
      <div className="pt-32 h-screen text-center mx-6">Hospital not found</div>
    );
  }
  ...
  return (
    <section className="flex flex-col lg:grid lg:grid-cols-6 lg:gap-6 mx-6 pt-32 mb-10 sm:mb-20 lg:mb-0 md:h-[34rem]">
      <div className="col-span-5">
        <div>
          ...
          <div>
            ...
            >
              <div className="modal-box !bg-[#3d4451]">
      ...
      <div className="mt-12 flex flex-col items-center ">
        ...
        <div className="flex justify-center items-center">
          ...
          >
            <FaXTwitter  className="w-7 h-7 mx-2 hover:text-blue-400" />
          </TwitterShareButton>
          <FacebookShareButton
            url={URL}
